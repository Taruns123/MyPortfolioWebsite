          ...
          <div className="grid-container">
            <div className="rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center">
              <Globe
                ...
                labelsData={[{ lat: 19.07, lng: 72.88, text: 'I am from MUMBAI!', color: 'white', size: 15 }]}
              />
            </div>
            <div>
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-xl md:text-lg font-medium text-gray_gradient text-white">tarunshetty190702@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
